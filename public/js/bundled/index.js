...
<<<<<<< HEAD
/* eslint-disable */ // import 'regenerator-runtime/runtime';
=======
/* eslint-disable */ var _runtime = require("regenerator-runtime/runtime");
>>>>>>> aefcbeebf92d7aadb7a30467368e819de75a5b50
...
var _passwordJs = require("./password.js");
var _ratingJs = require("./rating.js");
// DOM ELEMENTS
...
if (forgotForm) forgotForm.addEventListener("submit", (e)=>{
    ...
    (0, _passwordJs.forgotPassword)(email);
});
if (resetForm) resetForm.addEventListener("submit", (e)=>{
    e.preventDefault();
    const password = document.getElementById("reset-password").value;
    const passwordConfirm = document.getElementById("reset-password-confirm").value;
    (0, _passwordJs.resetPassword)(password, passwordConfirm);
});
if (reviewForm) {
    reviewForm.addEventListener("submit", (e)=>{
        e.preventDefault();
        const review = document.getElementById("review-text").value;
        const rating = +document.querySelector('input[name="star"]:checked').id.split("-")[1];
        const { tourId  } = e.target.dataset;
        (0, _ratingJs.sendReview)(review, rating, tourId);
    });
    document.querySelector(".reviews__star-rating").addEventListener("click", (e)=>{
        if (!e.target.id) return;
        const rating = e.target.id.split("-")[1];
        (0, _ratingJs.disableActiveStar)();
        (0, _ratingJs.setActiveStar)(rating);
    });
}
...
<<<<<<< HEAD
},{"./login.js":"7yHem","./mapbox.js":"3zDlz","./updateSettings.js":"l3cGY","./stripe.js":"10tSC","./signup.js":"fNY2o","./password.js":"ie1zQ","./rating.js":"dNp4W"}],"7yHem":[function(require,module,exports) {
=======
},{"regenerator-runtime/runtime":"dXNgZ","./login.js":"7yHem","./mapbox.js":"3zDlz","./updateSettings.js":"l3cGY","./stripe.js":"10tSC","./signup.js":"fNY2o","./password.js":"ie1zQ","./rating.js":"dNp4W"}],"dXNgZ":[function(require,module,exports) {
/**
...
<<<<<<< HEAD
var Buffer = require("3339752bf6c6ec11").Buffer;
=======
var Buffer = require("b92862eee4c3ed96").Buffer;
>>>>>>> aefcbeebf92d7aadb7a30467368e819de75a5b50
"use strict";
/**
...
<<<<<<< HEAD
},{"3339752bf6c6ec11":"fCgem","../utils.js":"5By4s","../core/AxiosError.js":"3u8Tl","../platform/node/classes/FormData.js":"aFlee","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fCgem":[function(require,module,exports) {
=======
},{"b92862eee4c3ed96":"fCgem","../utils.js":"5By4s","../core/AxiosError.js":"3u8Tl","../platform/node/classes/FormData.js":"aFlee","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fCgem":[function(require,module,exports) {
>>>>>>> aefcbeebf92d7aadb7a30467368e819de75a5b50
/*!
...
<<<<<<< HEAD
var base64 = require("db834a9acacb26bb");
var ieee754 = require("21a06c86ec9bfd7");
=======
var base64 = require("cbe83fad1430a53c");
var ieee754 = require("d69f84a4d8b72a72");
>>>>>>> aefcbeebf92d7aadb7a30467368e819de75a5b50
...
<<<<<<< HEAD
},{"db834a9acacb26bb":"eIiSV","21a06c86ec9bfd7":"cO95r"}],"eIiSV":[function(require,module,exports) {
=======
},{"cbe83fad1430a53c":"eIiSV","d69f84a4d8b72a72":"cO95r"}],"eIiSV":[function(require,module,exports) {
>>>>>>> aefcbeebf92d7aadb7a30467368e819de75a5b50
"use strict";
...
const updateSettings = async (data, type)=>{
    try {
        ...
        if (res.data.status === "success") (0, _alertsJs.showAlert)("success", `${type[0].toUpperCase() + type.slice(1)} updated successfully`);
    } catch (err) {
        (0, _alertsJs.showAlert)("error", err.response.data.message);
    }
};
...
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _alertsJs = require("./alerts.js");
const stripe = Stripe("pk_test_51MnlgALoWQNLaTPB0KjvezW9oCw5sf9rzjh7IsMttSiRy5FMx8NdKTVmYZiK5CI49bzej60vRgqt4ZBRx8ns2O9100Tu94fkdI");
...
},{"axios":"jo6P5","./alerts.js":"6Mcnf","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fNY2o":[function(require,module,exports) {
/* eslint-disable */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
>>>>>>> aefcbeebf92d7aadb7a30467368e819de75a5b50
        ...
        if (res.data.status === "success") {
            (0, _alertsJs.showAlert)("success", "Created account successfully");
            window.setTimeout(()=>{
                location.assign("/");
            }, 1500);
        }
...
},{"axios":"jo6P5","./alerts.js":"6Mcnf","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ie1zQ":[function(require,module,exports) {
/* eslint-disable */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const forgotPassword = async (email)=>{
    try {
        ...
        if (res.data.status === "success") (0, _alertsJs.showAlert)("success", "Email succesfully sent!");
    } catch (err) {
        (0, _alertsJs.showAlert)("error", err.response.data.message);
    }
};
const resetPassword = async (password, passwordConfirm)=>{
    try {
        ...
        if (res.data.status === "success") {
            (0, _alertsJs.showAlert)("success", "Password changed!");
            window.setTimeout(()=>{
...
},{"axios":"jo6P5","./alerts.js":"6Mcnf","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dNp4W":[function(require,module,exports) {
/* eslint-disable */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "sendReview", ()=>sendReview);
parcelHelpers.export(exports, "disableActiveStar", ()=>disableActiveStar);
parcelHelpers.export(exports, "setActiveStar", ()=>setActiveStar);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _alertsJs = require("./alerts.js");
const sendReview = async (review, rating, tourId)=>{
    try {
        ...
        if (res.data.status === "success") {
            (0, _alertsJs.showAlert)("success", "Review created!");
            window.setTimeout(()=>{
                location.reload();
            }, 1500);
        }
...
const disableActiveStar = ()=>{
    for(let i = 1; i <= 5; i++){
        const star = document.getElementById(`star-${i}`).closest(".star-container").querySelector(".reviews__star-svg");
        star.classList.remove("reviews__star--active");
        star.classList.add("reviews__star--inactive");
    }
};
const setActiveStar = (rat)=>{
    for(let i = 1; i <= rat; i++){
        const star = document.getElementById(`star-${i}`).closest(".star-container").querySelector(".reviews__star-svg");
...
},{"axios":"jo6P5","./alerts.js":"6Mcnf","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["5JCc9","f2QDv"], "f2QDv", "parcelRequire11c7")
